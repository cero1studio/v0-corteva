...
export default function EditarProductoPage({ params }: PageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Añadir la URL de la imagen actual
      if (currentImageUrl) {
        formDataObj.append("currentImageUrl", currentImageUrl)
      }

      // Añadir la imagen nueva si existe
      ...
      if (result.success) {
        ...
        toast({
          title: "Error",
          description: result.error || "Ha ocurrido un error al actualizar el producto",
          variant: "destructive",
        })
      }
    } catch (error) {
