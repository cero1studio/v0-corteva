...
import { toast } from "@/hooks/use-toast" // Client-side toast for validation errors
import { useState } from "react" // For client-side form state and validation
...
export default async function NewClientPage() {
  ...
  const handleSubmit = async (formData: FormData) => {
    ...
    formData.append("representative_id", teamCaptain!.id)
