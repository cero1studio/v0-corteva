...
import type { SimpleTeamRanking } from "@/app/actions/ranking-simple"

interface SimpleRankingDisplayProps {
  zoneTeams: SimpleTeamRanking[]
  nationalTeams: SimpleTeamRanking[]
  zoneName: string
  error?: string
}

export function SimpleRankingDisplay({ zoneTeams, nationalTeams, zoneName, error }: SimpleRankingDisplayProps) {
  if (error) {
    return (
      <div className="flex justify-center items-center h-64">
        <div className="text-center">
          <h3 className="text-lg font-semibold text-red-600">Error al cargar ranking</h3>
