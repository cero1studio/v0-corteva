...
function ArbitroDashboardContent() {
  ...
  useEffect(() => {
    ...
    const checkUserAndLoadData = async () => {
      ...
      try {
        ...
        // Guardar datos del distribuidor del equipo del árbitro
  ...
  async function loadZoneData(zoneId: string) {
    try {
      ...
      console.log("Cargando datos de la zona (Árbitro):", zoneId)
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-3xl font-bold tracking-tight">¡Bienvenido, {userData?.full_name || "Árbitro"}!</h2>
        ...
        <Card className="border-2 border-corteva-100">
          ...
          <CardFooter>
            <Button asChild variant="ghost" size="sm" className="w-full">
              <Link href="/arbitro/equipos">Ver Equipos</Link>
            </Button>
          </CardFooter>
        </Card>
          ...
          {teamsData.length > 6 && (
            <div className="text-center">
              <Button asChild variant="outline">
                <Link href="/arbitro/equipos">Ver todos los equipos</Link>
              </Button>
            </div>
          )}
        </TabsContent>
...
export default function ArbitroDashboard() {
  return (
    <AuthGuard allowedRoles={["arbitro"]}>
      <ArbitroDashboardContent />
    </AuthGuard>
  )
}
